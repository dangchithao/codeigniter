...
<head>
    ...
    <title>Thời Trang | Vitbay.vn</title>
    <style type="text/css">
    ...
    <div id="wrapper" align="center"> 
        ...
        <div id="container">
            <div class="maincontent">
                <div id="sidebar">
                    ...
                    <ul>
                        ...
                        <li><a href="" title="Giầy">Giầy</a></li>
                ...
                <div class="content">
                    <div id="j-img">
                        <img src="<?php echo base_url("web/photos/ci-thoitrang.jpg");?>" width="780px" height="300px"/>
                    </div>
                    <div id="jmg-con">
                        <img src=""/>
                    </div>
            ...
            <div class="spquantam">
                ...
                <div id="listsp">
                    <div>
                        <img src="<?php echo base_url("web/photos/ci-thoitrang.jpg");?>"/>
                        <h5>Thời trang</h5>
                    </div>
                    <div>
                        <img src="<?php echo base_url("web/photos/ci-thoitrang.jpg");?>"/>
