    ...
    <div id="wrapper" align="center">
        ...
        <div id="container">
            <div class="maincontent">
                <div id="sidebar">
                    ...
                    for($i=0; $i<count($total); $i++)
                    {
                        echo "
                            <ul>
                                <li>
                                    <img src='".base_url("web/photos/".$picture[$i])."' width='150px' height='200px'/>
                                </li>
                ...
                <div class="sach_tacgia">
                    <div id="top_sach">
                        <div id="img_author">
                            <img src="<?php echo base_url("web/photos/hoi.jpeg");?>"/>
                        </div>
                        <div id="author">
                            <b><?php echo $author;?></b>
                            <p>
                                Ví dụ: Để kiểm tra nickname đã tồn tại trong cơ sở dữ liệu hay chưa thì khi thành viên vừa nhập xong nick name, thông tin trên form lập tức javascript
                                nắm thông tin rồi thực hiện gọi một hàm bằng PHP bên phía server để kiểm tra thông tin sau đó trả kết quả html về cho javascript xuất ra cho người dùng biết tính hợp lệ của nickname,
                                lúc đó ngươid ùng có thể thay đổi ngay chớ không cần đợi submit rồi kiểm tra và nhập lại như dùng PHP truyền thống.
                            </p>
                        </div>
                    </div>
                    ...
                    <div id="tatca_sach">
                        <div id="p_sach">
                            ...
                            for($i=0; $i<count($total); $i++)
                            {
                                ...
                                echo "
                                    <div id='image'>
                                        <img src='".base_url("web/photos/".$picture[$i])."'/>
                                    </div>
                                    <div id='p_info'>
